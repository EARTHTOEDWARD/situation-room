...
**Build:** multiplayer public alpha v0.1.1  
**Date:** 2026-07-21
...
6. complete six-round all-AI run with bounded tracks;
...
- all-AI completion and debrief;
- 390-pixel mobile layout with no horizontal overflow;
- required static routes and multiplayer contracts.
...
- rebuilt standalone multiplayer HTML after the feedback addition.

The GitHub CLI path uses `gh repo create --public --source=. --push`, and the included Pages workflow deploys the repository root.

## Balance probe

Two hundred deterministic all-AI games were run across seeds `bal-0` through `bal-199`.
...
This is a stability probe, not evidence of human balance. The AI is intentionally heuristic and scenario-specific.
